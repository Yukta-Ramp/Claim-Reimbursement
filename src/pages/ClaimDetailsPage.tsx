    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          <h2 className="text-gray-900 mb-2">Claim Not Found</h2>
          ...
          <CollapsibleContent>
            <CardContent className="pt-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-6">
                ...
                <div>
                  <p className="text-sm text-gray-500 mb-1">Total VAT</p>
                ...
                {claim.supervisorApprovedDate && (
                  <div>
                    <p className="text-sm text-gray-500 mb-1">Supervisor Approved</p>
                    <p className="text-gray-900">
                ...
                {claim.financeApprovedDate && (
                  <div>
                    <p className="text-sm text-gray-500 mb-1">Finance Approved</p>
                    <p className="text-gray-900">
            ...
            <CardContent className="pt-6">
              {claim.bills.length === 0 ? (
                <div className="text-center py-12 text-gray-400">
                  <p>No bills added to this claim yet.</p>
                </div>
              ) : (
