...
import { Plus, Filter, Eye, FileX, Search, X } from 'lucide-react';
import { toast } from 'sonner';
import { Badge } from '../components/ui/badge';
import { TableHeaderFilter } from '../components/claims/TableHeaderFilter';
...
export const LandingPage: React.FC = () => {
  ...
  const getClaimsByStatus = (status: ClaimStatus | 'All') => {
  ...
  const desktopStatuses: (ClaimStatus | 'All')[] = [
    'All',
    'Drafted',
    'Submitted',
    'Supervisor Approved',
  ...
  const mobileStatuses: (ClaimStatus | 'All')[] = [
    'All',
    'Drafted',
    'Submitted',
    'Supervisor Approved',
  ...
  const handleFilter = (column: keyof ColumnFilters, value: string) => {
      ...
      <div className="flex-1 container mx-auto px-4 py-8 md:px-8 pb-24 md:pb-8">
        ...
        {!isMobile && (
          <div className="bg-white rounded-lg p-6 mb-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-gray-900 mb-1">Reimbursement Claims</h1>
                <p className="text-gray-500 text-sm">Manage and track your expenses</p>
              </div>
        ...
        {isMobile && (
          <div className="mb-6 mt-6">
            <h1 className="text-gray-900 mb-1">My Claims</h1>
        ...
        {isMobile && (
          <div className="space-y-3 mb-6">
            <Select value={activeStatus} onValueChange={(value: string) => setActiveStatus(value as ClaimStatus | 'All')}>
