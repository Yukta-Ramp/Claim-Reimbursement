...
import { MileageRate, Entity } from '../../types';
import { mockMileageRates, mockEntities } from '../../lib/mockData';
...
export const MileageRatesPanel: React.FC = () => {
  const [selectedEntity, setSelectedEntity] = useState<Entity>(mockEntities[0]);
  const [rates, setRates] = useState<MileageRate[]>(mockMileageRates);
  ...
  const handleEditRate = (rate: MileageRate) => {
